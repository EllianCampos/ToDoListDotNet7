namespace PRESENTACION
{
	partial class FrmConfig
	{
		...
		private void InitializeComponent()
		{
			...
			label2.Location = new Point(217, 77);
			label2.Name = "label2";
			...
			lsbEstados.Location = new Point(217, 96);
			...
			btnEliminarEstado.Location = new Point(467, 186);
			...
			btnAgregarEstado.Location = new Point(217, 185);
			...
			btnAgregarCategoria.Location = new Point(217, 370);
			...
			btnEliminarCategoria.Location = new Point(467, 372);
			...
			txtEstados.Location = new Point(251, 188);
			...
			btnEditarEstado.Location = new Point(433, 186);
			...
			lsbCategorias.Location = new Point(217, 280);
			...
			txtCategorias.Location = new Point(251, 372);
			...
			btnEditarCategoria.Location = new Point(433, 370);
			...
			label1.Location = new Point(206, 576);
			label1.Name = "label1";
